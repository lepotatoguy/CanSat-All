...
public class GUI {
	...
	/*	JPanel bottomPanel = new JPanel();
		...
		// chart.setSize();
		window.getContentPane().add(chartPanel1, BorderLayout.EAST);
		chartPanel1.setPreferredSize(new java.awt.Dimension(300, 300));
		chartPanel1.setSize(new java.awt.Dimension(300, 300));
        window.validate();
		...
		// chart.setSize();
		window.getContentPane().add(chartPanel2, BorderLayout.WEST);
		...
		chartPanel2.setPreferredSize(new java.awt.Dimension(300, 300));
		// chart.setSize();
		window.getContentPane().add(chartPanel3, BorderLayout.CENTER);
		...
		chartPanel4.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
		// chartPanel1.setDomainZoomable(true);
		//chartPanel2.setMouseZoomable(true);
		chartPanel4.setPreferredSize(new java.awt.Dimension(300, 300));
		// chart.setSize();
		window.getContentPane().add(chartPanel4, BorderLayout.SOUTH);
